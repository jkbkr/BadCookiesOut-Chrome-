...
public class BadCookiesWebSite_3 extends Constructor{
    ...
    public static void buttonsLoop(){
        ...
        List<WebElement> checkedButtons = driver.findElements(By.xpath("//label[contains(@class, 'sn-switch')]//input[@type='checkbox']"));
        ...
        for (WebElement badCookiesButton : checkedButtons) {
            ...
            if (badCookiesButton.isDisplayed() && badCookiesButton.isSelected()) {
